...
public:
    /*
     * Sanity check for importance sampling. Compares importance sampled BRDF with uniform sampling.
     * Useful to check if BRDF::eval and BRDF::sample are implemented correctly
     */
    static bool testBrdfSampling(BRDF* brdf) {
